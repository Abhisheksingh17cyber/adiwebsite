...
const services = [
  ...
  },
  {
    ...
    desc: "Hook-driven short-form edits optimised for Instagram Reels, YouTube Shorts, and TikTok — precision paced and built to retain attention from first frame to last.",
    features: ["Dynamic pacing & jump cuts", "Trending audio sync", "Captions & subtitles", "Vertical & square formats", "B-roll integration"],
    deliverable: "30 sec – 3 min",
  ...
  },
  {
    ...
    desc: "Timeless, emotional wedding films that capture every tender moment — the laughter, the tears, the vows — and weave them into a story you'll treasure for life.",
    features: ["Highlight reel (3–5 min)", "Full ceremony edit", "Same-day edit option", "Drone footage integration", "Custom music licensed"],
    deliverable: "3 min – 2 hrs",
  ...
  },
  {
    ...
    features: ["10–20 pieces per pack", "Multi-platform formats", "Consistent brand style", "Fast 48hr turnaround", "Scheduling-ready files"],
    deliverable: "10–20 videos/pack",
  ...
  return (
    <div className="py-28 relative overflow-hidden" style={{ background: "#080808" }}>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative">
        ...
        <h1 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: "clamp(3rem,6vw,7rem)", fontWeight: 300, color: "#f8f6f0", lineHeight: 1.05, letterSpacing: "-0.01em" }}>{title}</h1>
  ...
  return (
    <>
      <PageHeader
        ...
        subtitle="Every service is delivered with the same obsessive attention to detail — because your story deserves nothing less."
      />
      ...
      <section className="py-20" style={{ background: "#0a0a0a" }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
                      ...
                      <div className="lg:col-span-5">
                        <div className="flex items-start gap-5 mb-6">
                          ...
                          <div>
                            ...
                            <h2 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: "2.4rem", fontWeight: 500, color: "#f8f6f0", lineHeight: 1.1 }}>{svc.title}</h2>
                          </div>
                        </div>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mt-20">
            <p className="mb-6" style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: "1.8rem", fontWeight: 400, color: "rgba(248,246,240,0.7)", fontStyle: "italic" }}>
